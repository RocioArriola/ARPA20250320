...
public partial class Test20250320DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__Brands__DAD4F3BEE6120474");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED57175B2B");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC96DA695C");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534E5557FB9").IsUnique();
        ...
        {
            entity.HasKey(e => e.WarehouseId).HasName("PK__Warehous__2608AFD9A8CE1639");
